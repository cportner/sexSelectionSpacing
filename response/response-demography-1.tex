...
The ``cultural'' explanation is that originally those with higher education where also 
...
the higher castes and lead to assimilation of the high caste son preference norms.
...
The cultural explanation also suggests a reason for why the stated son preference appear 
...
Since I have no way of separating out these two possible explanation with the available
data and set up, I have not included this discussion in the paper itself. 
One possible approach would be to included this as a question for future research in the
Conclusion.
...
\item 7. It is not clear why exactly 22, 23, 25 years are used a cut-off
points.
...
to simplify.
Even with the stricter cut-off there are, however, still some evidence of recall error 
where the sex ratio was substantially biased against females  before sex selection became 
available.


\item 8. I understand the empirical reason for not increasing the number of
