...
24.65 with an eight months or fewer duration between marriage and first birth, and 0.95 
percent with a negative duration.
...
[Maybe it makes the most sense to simply drop the analysis of first spell]

[What to do with fecundity variable?]
...
I have divided India into four broad regions depending on degree of son preference and
initial fertility level (inspired by the categories in \citep{retherford03b}, but
expanded to include all states in the surveys).
In addition to the potential power problem, the division also means that there now are 
four times as many tables and graphs, which exacerbate the concern in comment 9 below.
I have, therefore, selected what I consider the most important results and presented
those in graphical format. 
