...
* an_spell3_g3_hindu_med_graphs.do
* Begun.: 07/04/10
* Edited: 2015-03-12
...
forvalues group = 3/3 {
        ...
        gen id = .
        // `e(estimates_note1)'
        estimates use `work'/results_spell3_g`group'_hindu_med
...
//         loc goptions "xtitle(Quarter) clpattern("l" "-" "-") legend(off) clwidth(medthick..) mlwidth(medthick..) yline(105, lstyle(foreground) extend)"
        ...
        forvalues k = 1/6 {
            ...
            !a2ping `figdir'/spell3_g`group'_med_r`k'_pc.eps
        }
...
//             graph export `figdir'/spell3_g`group'_med_r`k'_rr.eps, replace
//             !a2ping `figdir'/spell3_g`group'_med_r`k'_rr.eps
//         }
        ...
        forvalues k = 1/6 {
            ...
            graph export `figdir'/spell3_g`group'_med_r`k'_h.eps, replace
            !a2ping `figdir'/spell3_g`group'_med_r`k'_h.eps
        }
        ...
        forvalues k = 1/6 {
            ...
            !a2ping `figdir'/spell3_g`group'_med_r`k'_s.eps
        }
}
