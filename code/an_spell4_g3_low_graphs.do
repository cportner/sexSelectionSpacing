...
* an_spell4_g3_hindu_low_graphs.do
* Begun.: 09/04/10
* Edited: 2016-02-03
...
forvalues group = 3/3 {
        ...
        gen id = .
        // `e(estimates_note1)'
        estimates use `work'/results_spell4_g`group'_hindu_low
...
//        replace mom_age2 = mom_age^2 / 100
        ...
        forvalues k = 1/8 {
            ...
            graph export `figdir'/spell4_g`group'_low_r`k'.eps , replace
            !a2ping `figdir'/spell4_g`group'_low_r`k'.eps
        }
...
//         loc goptions "xtitle(Quarter) clpattern("l" "-" "-") legend(off) clwidth(medthick..) mlwidth(medthick..) yline(105, lstyle(foreground) extend)"
        ...
        forvalues k = 1/8 {
            ...
            replace pc`k'_u = . if pc`k'_u > 90
            replace pc`k'_l = . if pc`k'_l < 25
            line pc`k' pc`k'_l pc`k'_u t, sort `goptions' ylabel(25(5)90)
            graph export `figdir'/spell4_g`group'_low_r`k'_pc.eps, replace
            !a2ping `figdir'/spell4_g`group'_low_r`k'_pc.eps
        }
...
//             graph export `figdir'/spell4_g`group'_low_r`k'_rr.eps, replace
//             !a2ping `figdir'/spell4_g`group'_low_r`k'_rr.eps
//         }
        ...
        forvalues k = 1/8 {
            ...
            graph export `figdir'/spell4_g`group'_low_r`k'_h.eps, replace
            !a2ping `figdir'/spell4_g`group'_low_r`k'_h.eps
        }
        ...
        forvalues k = 1/8 {
            ...
            graph export `figdir'/spell4_g`group'_low_r`k'_s.eps, replace
            !a2ping `figdir'/spell4_g`group'_low_r`k'_s.eps
        }
}
