...
* an_spell1_g2_hindu_low_graphs.do
* Begun.: 08/04/10
* Edited: 2015-03-12
...
forvalues group = 2/2 {
        ...
        gen id = .
        // `e(estimates_note1)'
        estimates use `work'/results_spell1_g`group'_hindu_low
...
//        replace mom_age2 = mom_age^2 / 100
        ...
        forvalues k = 1/2 {
            ...
            graph export `figdir'/spell1_g`group'_low_r`k'.eps , replace
            !a2ping `figdir'/spell1_g`group'_low_r`k'.eps
        }
...
//         loc goptions "xtitle(Quarter) clpattern("l" "-" "-") legend(off) clwidth(medthick..) mlwidth(medthick..) yline(105, lstyle(foreground) extend)"
        ...
        forvalues k = 1/2 {
            ...
            !a2ping `figdir'/spell1_g`group'_low_r`k'_pc.eps
        }
...
//             graph export `figdir'/spell1_g`group'_low_r`k'_rr.eps, replace
//             !a2ping `figdir'/spell1_g`group'_low_r`k'_rr.eps
//         }
        ...
        forvalues k = 1/2 {
            ...
            graph export `figdir'/spell1_g`group'_low_r`k'_h.eps, replace
            !a2ping `figdir'/spell1_g`group'_low_r`k'_h.eps
        }
        ...
        forvalues k = 1/2 {
            ...
            !a2ping `figdir'/spell1_g`group'_low_r`k'_s.eps
        }
}
