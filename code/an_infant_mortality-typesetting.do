...
//                     local label `" order(3 "1st girl, 2nd boy" 4 "1st girl, 2nd girl" 1 "1st boy, 2nd boy" 2 "1st boy, 2nd girl") col(1) subtitle("First Child, Second Child", size(vsmall)) "'
                    local label `" order(3 "girl, boy" 4 "girl, girl" 1 "boy, boy" 2 "boy, girl") subtitle("Sex of first and second child", size(small)) "'
...
//                 local label `" order(3 "1st girl, 2nd boy" 4 "1st girl, 2nd girl" 1 "1st boy, 2nd boy" 2 "1st boy, 2nd girl") "'
            ...
            if "`educ'" == "low" | "`educ'" == "high" {
                if `period' == 1 {
                    loc y_info `"ytitle("{bf:1972-1984}")"'
                }
                if `period' == 2 {
                    loc y_info `"ytitle("{bf:1985-1994}")"'
                }
                if `period' == 3 {
                    loc y_info `"ytitle("{bf:1995-2004}")"'
                }
                if `period' == 4 {
                    loc y_info `"ytitle("{bf:2005-2016}")"'
                }
            ...
            if `period' == 1 {
                if "`educ'" == "low"     loc mort_title `"title("{bf:No education}", size(medium))"'
                if "`educ'" == "med"     loc mort_title `"title("{bf:1-7 years of education}", size(medium))"'
                if "`educ'" == "high"    loc mort_title `"title("{bf:8-11 years of education}", size(medium))"'
                if "`educ'" == "highest" loc mort_title `"title("{bf:{&ge}12 years of education}", size(medium))"'                
            ...
            if `period' == 4 {
                loc x_info `"xlabel(9 "9-20" 21 "21-32" 33 "33-44" 45 "45-56" 57 "57+" ) xtitle("{bf:Preceding Birth Interval (months)}")"'
...
//                 loc x_info "xscale(off)"
            ...
            marginsplot, x(b`spell'_d_space) noci /// 
                ...
                plotopts( ///
                    msymbol(i) ///
					ylabel(0 0.05 ".05" 0.1 ".10" 0.15 ".15" 0.20 ".20", grid angle(0)) plotregion(margin(zero) style(none)) ///
                    lwidth(medthin..) ///
                    yscale(range(0 0.25)) ///
                ) ///
