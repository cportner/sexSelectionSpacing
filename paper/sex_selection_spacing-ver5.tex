...
education---the difference in birth interval length across sex compositions has grown over 
...
consistently longer than the intervals with one or two boys, no matter the percentile used.
...
Sex selection, however, appears to be behind the most substantial increases in birth spacing. 
...
For these groups, when there are no sons, we now see the longest, rather than the shortest, 
birth intervals, consistent with substantial use of sex selection.
