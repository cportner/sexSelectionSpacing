...
Finally, did the advent of sex-selective abortions change the relationship between infant mortality and
birth spacing? 
...
Hence, some women with no sons now have longer birth intervals than those with
sons, reversing the traditional spacing pattern. 
Less-educated women continued short spacing when they have girls, with only limited 
evidence of male-biased sex ratios. 
Because of the rapid lengthening in spacing, period fertility rates substantially 
overestimated how fast cohort fertility fell. 
Furthermore, predicted cohort fertility remains above replacement for all but the 
best-educated urban women. 
If lengthening of birth intervals occurs from repeated abortions, the associated short 
pregnancy spacing may counteract any positive effects of longer birth spacing. 
...
difference in birth interval length across sex compositions has grown over time as spacing when 
sons are present has become longer.
...
Hence, it is possible that the lengthening of birth intervals with falling fertility arises
because unintended births become a relatively larger proportion of the total number of
births for a given parity.
...
birth interval length is close to 70 months. 
...
25th and median birth interval lengths. 
...
15 months, 
and the 75th percentile birth interval length increased by a staggering 21 months, most of 
...
As the sex ratio increased to close to 80\% boys, the expected median birth interval length
