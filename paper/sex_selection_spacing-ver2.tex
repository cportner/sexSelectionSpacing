...
Very short birth intervals are associated with worse health outcomes and increased 
...
Tables 
\ref{tab:bootstrap_duration_avg_sex_ratio_low_all}, 
\ref{tab:bootstrap_duration_avg_sex_ratio_med_all}, and 
\ref{tab:bootstrap_duration_avg_sex_ratio_high_all}.
...
As expected, fertility is lower than for women with no education, but still a
...
health, and with sex selection, the next child is likely a boy, it might make sense to 
...
It also means, that previous girls can expect more time without a younger sibling,
...
birth, the ``South'' has higher predicted fertility than the ``East.''
What is more, for urban areas the average birth interval has increased substantially
...
ratio, these changes are likely due to increased use of sex selection rather than a sudden
