...
[TK change based on rewrite of section]
...
The results show three major, interrelated trends over the last 40 years.
...
The results also show two very different approaches to son preference with important
...
\footnote{
Banning prenatal sex determination has not been able to reverse the use, although it is 
possible that it has slowed the rate of increase.
}
...
TK Distribution results

TK Regional differences
