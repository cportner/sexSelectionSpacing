...
As a result, we may observe the largest increases in average birth intervals for families 
with the strongest son preference, precisely because their preference for sons makes them 
more likely to use sex selection.
...
Both the non-randomness and differential spacing can be captured with a competing risk 
set up.
...
Second, the introduction of prenatal sex determination exacerbates any bias from the 
