...
Hence, longer birth intervals in the absence of sons, which previously would be taken to 
indicate a lower son preference, now may instead arise because couples with a strong son 
preference use sex selection.
...
birth in India from sex selection over the last three decades
...
have on spacing.
I address three questions to remedy this shortcoming.
...
For example, the motivation behind an increase in average spacing is different if it
comes mainly from parents trying to avoid very short birth intervals, which, as mentioned,
are associated with worse child outcomes, or from continued use of sex selection to
ensure a son.

Finally, how are the changes in birth intervals distributed geographically?
Given the cultural differences within India, it is unlikely that the increasing 
...
As a result, well-educated women now show a complete reversal of the traditional spacing 
...
Fourth, the traditional pattern of longer average spacing with sons appear to arise from 
...
There are two problems with this approach in this setting.
