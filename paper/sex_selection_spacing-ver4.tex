...
However, India also witnessed the appearance of sex selection---the selective 
abortion of female fetuses based on prenatal sex determination. 
Sex selection became available in the mid-eighties with the introduction of technologies 
such as ultrasound and amniocentesis. 
...
changes, especially the introduction and spread of sex selection? 
...
Second, the waiting time to conception is between one and six months. 
...
force participation are all also likely to impact birth spacing. 
Hence, the combined changes in birth spacing in India may be much more substantial than
 what we have observed in other countries.

Studying birth spacing is valuable because it contributes to our knowledge about 
fertility decisions and because of birth spacing's potential effects on outcomes such as 
fertility measures and mortality. 
To understand the effects of changes in birth spacing, I focus on two questions. 

First, to what extent do changes in birth spacing bias our standard fertility estimates?
Tempo effects from longer birth intervals make the total fertility rate a downward biased 
estimate of cohort fertility \citep{Hotz1997,Bongaarts1999,Ni-Bhrolchain2011}.
Hence, if birth intervals increased substantially over time, India's fertility may 
be higher than generally accepted.
...
To investigate how birth spacing has changed over time and across groups with the 
introduction of sex selection, I use a competing risk hazard model with two exit 
states: the birth of a girl or the birth of a boy. 
...
Because sex selection might affect the distribution of birth intervals, I also
...
The key explanatory variables are maternal education, the sex composition of previous 
children, and area of residence.

The empirical model allows me to predict cohort fertility. 
To examine to what extent tempo effects bias our standard fertility measures, I compare 
this predicted cohort fertility with fertility calculated from age-specific fertility rates.

I use the same data to study how infant mortality risk has changed with the changing 
birth spacing and whether sex selection directly affects infant mortality. 
The explanatory variables are the same as for the spacing analysis, except for the 
addition of birth spacing and index child sex. 

% Main results
There are four main results.

First, birth intervals have increased for all education groups over the four decades, but 
more so, the higher the parity and the higher the education. 
...
As a result, we now see cases that reverse the traditional spacing pattern, with women 
with no sons having \emph{longer} birth intervals than women with sons. 
Those least likely to use sex selection---women with less education in rural areas---still 
follow the traditional pattern of short spacing when they have girls and little evidence 
of sex selection.

Second, there is little change in the likelihood of having a very short birth interval. 
Hence, the increased average spacing comes mainly from the longer birth intervals getting 
even longer, primarily driven by substantial use of sex selection. 
The exception to this result is that those better-educated women who have a very high 
predicted use of sex selection conceive later precisely because the next child is almost 
certainly a boy. 
...
replacement level for all but the best-educated urban women.
...
the most education.
However, the mortality risk is still inversely related to education level, especially for 
