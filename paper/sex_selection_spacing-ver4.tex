...
higher order intervals because, with falling fertility, few women had five or more 
births, especially among the better-educated.
...
The quality of the birth date data is crucial since the reliability of the results depends 
on the correctness of the birth histories provided by the respondents.
...
If deceased children are not reported the birth intervals will be inflated and likely make 
the changes over time appear smaller than they really are.
I, therefore, provide a detailed analysis of systematic recall error in the Online Appendix.
Recall error is heavily dependent on how long ago a woman was married, and I, consequently, 
drop women married 22 years or more.%
\footnote{
\citet{Schoumaker2014} discusses the quality of birth histories in DHS surveys and the 
impact on fertility estimates.
Although that analysis does not directly examine systematic recall error, it is likely that
it explain why the first rounds of NFHS are listed as ``moderate quality.''
}
...
periods, based on the changes in access and legality of prenatal sex determination in India.
...
Finally, although the use of sex selection increased even after 1994, we may have passed a 
turning point in its use in the mid-2000s with son preference declining
\citep{Das_Gupta2009,Kumar2012,Bongaarts2013,Diamond-Smith2015}.%
\footnote{
Although see also \citep{Navaneetham2011}.
}

I use four periods: 1972--1984, 1985--1994, 1995--2004, and 2005--2016.
The first period covers before sex selection became available and the second the period 
from when sex selection became available until the Prenatal Diagnostic Techniques Act.
I have split the period from 1995 until 2016 into two to understand if there is any 
support for the prior literature's hypothesized reversal in child sex ratios and son 
preference in India.
