...
To investigate how birth spacing has changed over time and across groups with the introduction 
of sex selection, I apply a competing risk hazard model to the birth histories of Hindu 
women, covering the period 1972 to 2016, using data from the four National Family and 
Health Surveys (NFHS).
The model directly incorporates the effects of sex-selective abortions on birth intervals
and the likelihood of a son, but it also works with no sex selection.
