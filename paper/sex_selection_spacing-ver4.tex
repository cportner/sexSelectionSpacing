...
for the four education levels by area of residence.%
\footnote{
...
% [not sure where this goes or simply delete]
...
First, 
in line with the observed fall in the total fertility rate, the likelihood of a next birth 
has fallen over time.
The declines in the likelihood of a next birth are larger the higher the education, 
the higher the parity, and with the presence of at least one son. 
...
the parity.
There is some evidence of unnaturally high percentage boys for some women with one 
son, although most are clearly lower than in the absence of a son and the failing fertility
make these estimate noisy.


% [Birth intervals w/o sex selecition]

To separate out the effects of the introduction of sex selection and the other changes in
India, I first discuss how birth intervals have changed in situations where sex selection are 
less likely to be used.
This groups covers women with no education, no matter the sex composition of their children, 
and women with any education who has one or two sons already. 
[This is not a hard and fast separation ]

% [median birth intervals]
Most median birth intervals have increased by three to six months over the four 
decades, but the majority of median birth intervals are still at 36 months or below, 
...
These changes are substantially smaller than the 3.5 months increase per decade found
in other countries with declining fertility \citep{Rutstein2011,Casterline2016}.


% [25th percentile birth intervals]
Despite the increases in median birth intervals and the decline in fertility, a remarkably 
high proportion of birth intervals are still very short.
For all but the most educated, more than 25 percent of women have their second and their
third child within 24 months of their previous child, which is substantially below
the 24 between \emph{pregnancies} recommended by the WHO.
...
These results are in line with prior research showing that falling fertility is 
associated with increases in longer spacing, although it is still an 
unresolved question why \citep{Casterline2016}.
The parity progression probabilities have been falling over time across all 
education levels, especially for women with at least one son, and have been
failing less for the less educated women.

However, despite the rapidly declining probability of a third birth for the best-educated
women when they already have a son, the birth intervals changed little for any of the percentiles,
and all are lower for the third spell than for the second.
...
Women with the largest increases in birth intervals are also those least likely to work.
...
Son preference still show up clearly, even for the women the least likely to use sex 
selection, such as rural women with no education. 
...
longer than if they had at least one son, and an increase of more than 20 months over
the four decades.
...
64 months with two girls in a decade, while the other sex compositions showed a 
slightly decrease from around 55 months to 54 months.
Theses changes may even be an underestimate of the changes in birth spacing since
...
best-educated women is also the case with the clearest reversal in the spacing pattern by 
sex composition; the birth intervals with two girls are consistently longer than with one
...
some cases showing increases in sex ratios between the last two periods, others little change, 
and some a decline.
