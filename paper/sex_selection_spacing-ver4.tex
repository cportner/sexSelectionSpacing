...
[Urban low and rural highest in online Appendix]
...
The longest average interval was 51 months for the third spell for urban women with twelve 
or more years of education who had no boys, an increase of approximately a year over
4 decades.
For comparison, the median birth intervals reported for the NFHS have barely
moved over time, staying at approximately 31 months, and fast changing countries have 
median birth intervals that increase change around 3.5 months per decade 
\citep{Rutstein2011,Casterline2016}.%
\footnote{
Median estimates are in Appendix Tables \ref{tab:p25_p50_p75_low} through 
\ref{tab:p25_p50_p75_highest}.
}
This lack of change in the NFHS reported birth intervals over round underscores the 
importance of accounting for censoring of birth spells when trying to understand how birth 
spacing is changing over time.
...
approaching 80 and an average birth interval of 51 months. 
...
There was a six months jump, from 39.5 to 45.4, in average spacing between the first and 
the second period for women with two girls, but only a month increase for the other sex 
compositions.
Furthermore, the 75th percentile birth interval with two girls increased from 48 months to 
64 months with two girls over the period, while the other sex compositions showed a 
