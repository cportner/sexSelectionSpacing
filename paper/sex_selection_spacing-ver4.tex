...
% Demography abstract
\noindent 
In India, the most substantial lengthening in Hindu women's birth intervals over the last 
four decades occurred for the women most likely to use sex-selective abortions. 
For well-educated women with two girls, the median birth interval to the third child 
increased by nearly 15 months---and the 75th percentile interval by 21 months---as the 
sex ratio approached 80 percent boys. 
Because of the rapid lengthening in spacing, standard fertility rates significantly 
overestimated how fast cohort fertility fell. 
Despite convergence, cohort fertility is still ten to twenty percent higher than the 
...
have the longest. 
Finally, infant mortality has declined over time for all groups, but the decline was the 
...
\captionsetup[figure]{skip = -16}

\begin{figure}
\centering
\includegraphics[width=\textwidth,height=\textheight,keepaspectration=true]{bs_low_rural}
...
% \begin{figure}
% \centering
% \includegraphics[width=\textwidth,height=\textheight,keepaspectration=true]{bs_low_urban}
% \caption{Percentile birth intervals, sex ratios, and parity progression  
...
\begin{figure}
\centering
\includegraphics[width=\textwidth,height=\textheight,keepaspectration=true]{bs_med_rural}
\caption{Percentile birth intervals, sex ratios, and parity progression  
for rural women with one to seven years of education by spell, sex composition, and period}
\label{fig:spacing_med_rural}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\textwidth,height=\textheight,keepaspectration=true]{bs_med_urban}
\caption{Percentile birth intervals, sex ratios, and parity progression  
for urban women with one to seven years of education by spell, sex composition, and period}
\label{fig:spacing_med_urban}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\textwidth,height=\textheight,keepaspectration=true]{bs_high_rural}
\caption{Percentile birth intervals, sex ratios, and parity progression  
for rural women with eight to eleven years of education by spell, sex composition, and period}
\label{fig:spacing_high_rural}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\textwidth,height=\textheight,keepaspectration=true]{bs_high_urban}
\caption{Percentile birth intervals, sex ratios, and parity progression  
for urban women with eight to eleven years of education by spell, sex composition, and period}
\label{fig:spacing_high_urban}
\end{figure}

% \begin{figure}
% \centering
% \includegraphics[width=\textwidth,height=\textheight,keepaspectration=true]{bs_highest_rural}
% \caption{Percentile birth intervals, sex ratios, and parity progression  
% for rural women with twelve or more years of education by spell, sex composition, and period}
% \label{fig:spacing_highest_rural}
% \end{figure}

\begin{figure}
\centering
\includegraphics[width=\textwidth,height=\textheight,keepaspectration=true]{bs_highest_urban}
\caption{Percentile birth intervals, sex ratios, and parity progression  
for urban women with twelve or more years of education by spell, sex composition, and period}
...
This rate is shown as ``1987--88'' in the table.
...
Since parity progression depends on the sex composition of prior children, I estimate the 
...
Only recently, as the rate of increase for the birth intervals has slowed, do the two 
fertility measures begin to converge again.
Even with the convergence, the predicted 2005--16 cohort fertility is still above the 
1992--93 fertility rate for every group, except urban women with no education. 
Furthermore, for the last period, the predicted cohort fertility remains at least ten to 
twenty percent higher than the fertility rate.
...
For example, for urban women with eight to eleven years of education, the fertility
...
fertility clearly below 2.1.
Even then, cohort fertility is still more than 0.3 children higher than 
the fertility rate estimate of 1.5.
Furthermore, the predicted cohort fertility numbers are likely too low since I use only 
...
birth, until the 57 months dummy, which covers until 105 months after the prior birth.
...
\begin{figure}
\centering
\includegraphics[width=\textwidth,height=\textheight,keepaspectration=true]{mortality_low_med}
\caption{Infant mortality by preceding birth interval across periods for women with 
no education and women with one to seven years of education}
\label{fig:mortality_low_med}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth,height=\textheight,keepaspectration=true]{mortality_high_highest}
\caption{Infant mortality by preceding birth interval across periods for women with 
eight to eleven and twelve and above years of education}
\label{fig:mortality_high_highest}
\end{figure}
...
A total of 1,004 women with twelve or more years of education and no boys at the start of 
...
Half of those who died were born in the 9-32 months interval, and none in the 57 months 
and up interval.
...
significant changes in India over the last four decades, particularly the spread of sex 
selection.
...
As the sex ratio increased to almost 80 percent boys, the expected median birth interval 
for a woman with twelve or more years of education who has two girls increased by almost 
15 months, and the 75th percentile interval by 21 months.
Most of the increase in the long intervals came right after the introduction of sex 
selection in India.
...
spacing increases were smaller at three to six months over the four decades. 
...
In many cases, more than 25 percent have their next child within 24 months of the previous 
birth.  
...
However, it is still present, with the predicted cohort fertility ten to twenty percent 
