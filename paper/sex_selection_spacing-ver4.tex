...
For birth intervals, I estimate the average birth interval and a set of percentile
birth intervals.
...
Finally, I add nine months because spells begin nine months after the previous birth.
The process is similar for the percentile birth intervals, except that I use the time 
point when there is a given percent probability that a woman will give birth, conditional 
on her giving birth in the spell.
...
combination and then predict average birth interval in months, sex ratio, and the 
...
For comparison, the graphs for the sex ratio also show the natural sex ratio, 
approximately 51.2 percent \citep{ben-porath76b,jacobsen99,Portner2015b}.
