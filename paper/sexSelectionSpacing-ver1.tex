...
artifact of any remaining recall error not captured by the data restrictions.
Certain types of recall error would also explain why the sex ratio for
the second spell is statistically significantly \emph{below} the
natural sex ratio [TK cite my recall paper].
