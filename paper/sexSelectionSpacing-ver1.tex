...
First, spacing, by itself, can no longer be used to measure son preference. 
...
Second, the duration since last birth may affect the decision on sex selection.
...
Hence, by examining whether sex selection decisions change with
