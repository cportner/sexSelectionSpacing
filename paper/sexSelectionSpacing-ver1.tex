...
only girls.
However, because of falling fertility the number of births to women with 
only sons becomes small in the later periods, especially for the third and 
fourth spell.
Hence, it is possible to have substantial differences in spacing that are
not statistically significant because of low power.
Furthermore, it is, in principle, possible to estimate the model taking 
into account the ordering of children.
This would, however, further lower the power of the test, by leading to 
one extra group for the third spell and four extra groups for the fourth spell.
...
Each cell's predicted precent boys is tested against the natural percentage 
...
It is possible for the predicted percentage boys to be different from 
the natural rate either because of natural variation, any remaining
recall error, or sex selection. 
