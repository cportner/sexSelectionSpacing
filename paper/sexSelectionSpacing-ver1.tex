...
with spell length.
Second, if the degree of son preference vary within the sample
but behavior is not affected by duration from the previous birth,
...
% Examples of declining sex ratios 
...
% Examples of increasing sex ratios
...
\subfloat[2005--2016]{
   \begin{minipage}{0.39\textwidth}
       \captionsetup[subfigure]{labelformat=empty,position=top,captionskip=-1pt,farskip=-0.5pt}
       \subfloat[Prob.\ boy (\%)]{\includegraphics[width=\textwidth]{spell3_g4_high_rural_bg_pc}}\\
       \subfloat[Prob.\ no birth yet]{\includegraphics[width=\textwidth]{spell3_g4_high_rural_bg_s}}
       \captionsetup[subfigure]{labelformat=parens}
   \end{minipage}
}
\caption{Predicted probability of having a boy and probability of 
