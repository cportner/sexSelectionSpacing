...
On one hand, access to contraceptive allow women to avoid too 
...
This idea may explain why better educated women tha
shorter spacing than less educated women in certain 
cases \citep{Tulasidhar1993,Whitworth2002}.
...
Median durations can then be averaged across women using the probabilities 
of ending a spell with a child as weights.
How well this approach works depends on whether the spell length covered is 
sufficiently long that few women are be likely to give birth after
the spell cut-off.
...
The shapes of the survival curves provide clues both to general
changes in birth spacing and to whether parents are
...
The median duration for urban women increase between a quarter
and three-quarters of a year, whereas the increase for rural women 
is around a quarter of a year.
...
down from close to 60\% in the 1995--2004 period. 
...
spells are consistent with an increased access to contraceptives over
...
that censoring is an important issue when trying to understand the 
development in sex ratio.
...
Increased autonomy for women, for example from better opportunities
...
On the one hand, it is an clear benefit to the women who gain  
