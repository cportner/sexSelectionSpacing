...
That these changes are likely due to increased use of sex selection 
...
This points to two important, interconnected, questions for 
future research:
...
The results here also lead to a set of broader important questions that
...
On the one hand, it is an obvious benefit to the women in terms of 
bargaining power and it also increases the cost of repeated 
sex-selective abortions.
On the other hand, it may also further lower fertility, and everything 
else equal, that may lead to higher use of sex selection.
