...
10 to 20 percent fall into this category across the 4 surveys.
Although it is possible that some of these births are premature, the high number of
women who report a birth less than 6 months after marriage indicates that for
...
Furthermore, the other groups are so different in terms of background and son 
...
The four NFHS rounds allow me to show the development in spacing and 
sex ratio from before sex-selective abortions were available until 2016.
...
The final sample consists of TK women, with TK parity one through four births.
