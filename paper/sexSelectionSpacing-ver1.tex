...
% Might not fit very well here - maybe main point to discussion above and refer to Appendix
...
\caption{
Survival curves conditional on progression to first birth; start point is time of marriage.
}
...
\caption{
Survival curves conditional on progression to TK
}
\label{fig:pps_low}
\end{figure}
