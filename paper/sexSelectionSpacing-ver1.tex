...
Table \ref{tab:median_sex_ratio_low} show the predictions for women with 
no education.
Overall, spacing is shorter the fewer boys a couple has, although the
differences in median duration are never more than 3 months and most
are only one or two months.%
\footnote{
This is ignoring those cells with few births.
}
Furthermore, there is little change across the 3 periods.
This is consistent with an absence of sex-selective abortions for
this group of women.
