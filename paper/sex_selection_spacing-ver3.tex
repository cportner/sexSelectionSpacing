...
To understand the potential implications of the substantial changes in income, female 
education, and female labor force participation that India has experience on birth
spacing, this section discuss relevant theoretical frameworks and prior findings 
on birth spacing.
...
If the mother is unlikely to work in market work, as has become more common over time in 
India, there is little incentive to children more closely together for economic reasons.

% [TK not clear that these two paragraphs add anything to this section]
% The question is then why women appear to be leaving the labor force.
% With the strong economic growth in India, real wages for both men and women have almost 
% doubled between 1987 and 2011 \citep{Klasen2015}.
% Despite the increases in wages and the higher female education, the mean male wage is
% still close to 70 percent higher than the mean female wage and women’s labor supply 
% appear to be more negatively elastic to their husbands' wages than it is positively 
% elastic to own wages, suggesting that the reduction in female labor supply is driven by 
% an income effect \citep{Bhargava2018}.%
% \footnote{
...
% However, even after controlling for household characteristics and husband income, there 
% still is the U-shaped relationship between female education and labor supply shown
% above with the lowest labor force participation for women with secondary 
% education \citep{Chatterjee2018}.
...
% Second, with increasing education, women's productivity at home also increases, 
% especially in the production of offspring human capital.
...
With increasing income, parents may also prefer higher child ``quality'' and that would
also predict longer birth intervals since parental attention per child increases
...
average birth spacing through access and knowledge of contraception, the empirical 
...
when it comes to modern contraceptives such as pills or injectables 
...
The discussion has so far assumed that children are identical---except 
...
Appendix Tables \ref{tab:des_stat1} and \ref{tab:des_stat2} presents descriptive statistics for
