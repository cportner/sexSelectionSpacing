...
be counteracting effects if the longer spacing arises because of multiple abortions, but
...
no prior research has examined how sex selection affects spacing.
...
declining desired fertility, drove the increases in birth intervals for women with only girls and 
...
Women with eight to eleven years of education are 
expected to have lower fertility and 
higher use of sex selection, and we should, therefore, 
see substantial effects on spacing.
...
% } 
\caption{
Survival curves conditional on progression to next birth for urban women with twelve or
more years of education; start point is nine months after prior birth
}
\label{fig:pps_highest}
\end{figure}
...
First, how do the effects of short spacing vary by education level in India?
Second, has the negative effects of short spacing changed over time?
Finally, is the increased use of sex selection associated with higher mortality risk?
...
are done separately by education level and spell.

I estimate the probability of infant mortality using a logit model.
Figures \ref{fig:mortality_low} to \ref{fig:mortality_highest} present 
the predicted probability of dying within the first year at the possible 
combinations of index child sex, sex composition of prior children, and 
...
to term also have higher mortality risk for their offspring, the 
result may be a supriuos correlation between long birth spacing and 
mortality \citep{Kozuki2013}. 
...
On the positive side, the fixed effects results and linear probability in
prior research do not deviate substantially.
...
Women with no education have experienced substantial
improvements in infant mortality risk over time.
The decrease is especially pronounced for shorter
birth intervals.
The mortality risk for children with the shortest 
interval (the 0 to 11 months group, which is equivalent 
to 9 to 20 months after the prior birth) is
between 15 and 20 percent in the earlier periods, but
fall to less than 10 percent in the last period.

The mortality risk reductions for longer spells is
less pronounced, but still there.
For the latest period, the likelihood of dying within
the first year is below five percent.

Despite the prior findings of differential mortality
by sex, there is little evidence that girls have
substantially higher mortality risk, especially for
second births.
There is, however, some weak evidence that boys born
after two girls have slightly lower mortality risk,
...
Infant mortality risk for women with one to seven years 
of education have also clearly decreased over time.
This is also the first group that show increasing 
mortality risk with longer spacing, although this effect 
disappears for the later periods.
In other words, it does not appear to be the result of 
sex selection, but rather arise from the selection bias 
discussed above.
...
For women with eight to eleven years of education, 
mortality risk have decreased slightly between periods,
although the changes are relatively minor.
The elevated mortality risk with very short spacing
is still evident, but the difference is much smaller 
than for the lower education groups.

If sex selective abortions lead to higher mortality
risk we should see an increase for longer spacing
when the child was a born and the prior children were
all girls (the solid lines).
There are no apparent differences between these groups
and the other potential combinations.
If anything, mortality risk for boys born after girls
have slightly lower mortality.
None of the differences are statistical signficant.
...
Women with twelve or more years of education
have the lowest infant mortality risk based on the
second parity since the third parity results are very
noisy. 
Even for very short birth intervals the mortality risk is 
less than five percent,
and fall to less than half that for longer intervals.
Given the low mortality there is, not surprisingly, much 
difference between the three periods covered.
Furthermore, there is still no evidence that longer 
intervals are associated with significantly higher 
mortality, especially for the groups most likely to have
used sex selection (women with a girl as their first 
child and a boy as their second with a long interval).


Overall, the results show substantial convergence
in mortality risk across groups over time.
For the longer intervals, there is surprisingly little 
difference across the education groups for the later 
periods with even the no education group showing
an infant mortality risk of less than five percent.
