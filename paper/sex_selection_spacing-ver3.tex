...
Understanding how birth spacing changes is essential for two main reasons.

First, if birth intervals increase substantially over time, India's fertility may 
...
[Shorten/combine these two paragraphs]
...
Finally, how has the relationship between birth spacing 
and mortality changed over time?
Mortality risk is inversely related to education level,
especially for very short birth intervals.
However, infant mortality risk has decline substantial 
over time for the lower education groups and is now
close to the level of women with the most education.
There is no evidence that the increasing use of 
sex selection is associated with higher mortality risk.
...
The combination of rising incomes and continued son preference may even lead to longer 
spacing than what we would expect from the standard income effect alone.
...
\citep{Behrman1999}.
The result would be longer birth intervals if parental attention per child results in 
higher child ``quality'' \citep{Zajonc1975,Zajonc1976,Razin1980}.
...
birth spacing to increase the most among the better-educated because of their 
...
Figure \ref{fig:bootstrap_low} shows that women with no education follow a traditional 
approach to son preference with high fertility, shorter birth intervals with fewer sons, 
and minimal use of sex selection, but with crucial differences across spells.
I focus on rural women since most women without education in the sample live in urban 
areas.

Birth intervals have all increased over time, with the increases larger the higher the 
spell.
The increase for the second spell was only between one and two months, while the 
increases for the fourth spell were between five and nine months, depending on the
sex composition, with larger increases the more boys. 

Consistent with a high desired fertility, son preference has little effect on spacing for 
the second spell and virtually all women have a second birth independent of the sex of 
the first child.
Son preference in birth intervals shows up more clearly for the third, and, particularly, 
the fourth spell.
Furthermore, for the fourth spell, the difference across sex compositions are more 
pronounced over time, and the likelihood of having a fourth child has decreased for women 
...
birth intervals have increased slightly more than for women with no education, especially 
for the second spell where the increases are between three and six months.
...
are for women with two daughters and no sons, with an increase of about eight months.
...
That the substantial increases in spacing for women with only girls is not evidence of 
lower son preference is shown by the changes in the predicted sex ratios and the parity 
progression behavior.
For both the third and fourth spell, the predicted sex ratios in urban and rural areas are
statistically significantly above the natural sex ratio at between 55.4 and 57.7
percent boys.

The elevated sex ratios strongly suggest that sex selection drove the increases in birth 
intervals for women with only girls.
Without sex selection we would likely instead have observed a diverging pattern in birth 
...
As Figure \ref{fig:bootstrap_high} shows, there is little difference for the second spell 
between women with one to seven years of education and those with eight to eleven years, 
except that the birth intervals have increased by about two months more for the 
better-educated women.

For the third spell, however, the better-educated women have substantial larger increases
in birth intervals, with the largest increases when the first two children are girls,
where the increases are more than ten months for urban women and more than six for rural.
The result is that the longest average spells are for those without boys.
That this reversal is due to sex selection is clear from the predicted sex ratios,
which are around 60 percent.
A similar reversal pattern also shows up for the fourth spell for urban women, although
...
This points to even well-educated women might still have relatively high fertility if
they do not use sex selection, and that the majority will end up with at least two
children.
...
The impact that sex selection can have on birth spacing is illustrated particularly 
vividly by the reversal of the standard spacing pattern for the third spell for urban 
women with twelve or more years of education as shown in 
Figure \ref{fig:bootstrap_highest}.%
\footnote{
I do not show the results for the fourth spell since the low number of births,
especially for women with one or more boys make the spacing and sex ratio results
very noisy.
Results are available upon request.
}
In the 1972-1984 period, the predicted average birth intervals for the three possible sex 
compositions were only a couple of months apart, with the shortest spacing for women who 
had two girls.
Women with two girls had, however, the highest predicted average spacing in the later
periods, with about seven months longer birth intervals than women with one or two boys.

The increase in average birth intervals for urban women with two girls from 30.5 to 42.3 
months corresponds directly to the sex ratio going from 60 to 77 percent. 
The sex ratio of 60 percent for urban women with two girls in the first 
period indicates that this group of women were early users of sex selection, and that
in the absence of sex selection we would have observed an even larger difference in
birth intervals for the first period.

The seven months increases in spacing for the second spell are in line with the results 
above, although with an average spacing of 29 months in the 1972--84 period, the birth
intervals for this group begin where the women with eight to eleven years of education
ended.
Furthermore, the predicted sex ratio is significantly above the natural ratio for the 
three later periods, and around 60 percent for the two last periods.

Finally, despite decreases in the parity progression probability, women without sons 
are still likely to have an additional child.
Close to 80 percent of urban women with a girl as their first child are predicted to
have a second child and more than half with two girls will have a third child.
For women with sons the decline has been faster, but mainly for the third spell; with a
boy as their first child, close to 70 percent will have a second child.
...
Even with the convergence, the predicted cohort fertility for the last period is above 
the 1992--93 fertility rate for every group except urban women with no education.
Furthermore, for the last period, the predicted cohort fertility is stil between
...
Despite the declines in the predicted cohort fertility based on the hazard model, 
predicted cohort fertility is still mostly above the generally accepted replacement 
level of 2.1.
...
- lower mortality and a higher than previously anticipated fertility implies that 
population growth in India is higher than expected.
]
...
[from mortality section]
Furthermore, with the adverse effects of shorter spacing 
strongly mitigated by higher education and no apparent 
increase in mortality risk from sex selection,
better-educated women can both try to conceive early
and and use multiple abortion in the absence of a boy
