...
we observe a reversal of the traditional spacing pattern.
...
account both the likelihoods of parity progression and having a child of a specific sex.
I compare those predictions with fertility rate estimates based on the same data to
show how the increases in birth spacing has led to a substantial overestimate of the
decline in fertility [TK too imprecise? underestimate of the level, rather?]
