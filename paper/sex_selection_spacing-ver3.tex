...
To predict cohort fertility based on the models above, I estimate the probability of 
progression to the next parity for each spell.
...
Hence, for a woman married at age 20, I use age 22 for predicting progression 
...
For example, the likelihood of a second birth is the probability of having a first birth 
multiplied with
sum of the 
...
follows the parity progression probability based on the given period. 
For example, for the NFHS-4 the predictions assume that the women in the sample follow
the estimated behavior for all four spells based on the 2005--2016 sample.




The predicted cohort fertility based on the hazard model is consistently higher and
declines faster than the predicted fertility based on the four-parity fertility rate.
...
Consistent with the rapid increase in the use of sex selection from the mid-eighties
the most substantial differences between the two fertility measures are for higher
educated women for earlier samples.
