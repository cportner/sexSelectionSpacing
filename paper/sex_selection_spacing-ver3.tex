...
India has changed significantly over the last three decades:
the economy has grown substantially,
education has increased for both males and females,
and the total fertility rate has fallen to the point where, at 2.2, it is just
above replacement 
\citep{Bosworth2008,Guilmoto2013,Dharmalingam2014,International-Institute-for-Population-Sciences-IIPS2017}.
However, access to prenatal sex determination also expanded rapidly starting in the mid-1980s,
and, combined with a continued strong son preference, this dramatically increased the 
males-to-females ratio at birth 
...
What has not previously been examined is the impact of these changes on birth spacing.
Economic growth, increasing female education, and falling fertility has been
shown to significantly affect birth spacing in other countries [TK references].
India is, however, fundamentally different in at least one respect and that is 
the substantial use of sex-selective abortions.

The stronger the son preference and the lower the desired fertility, the more likely 
couples are to resort to sex-selective abortions, and each abortion increases the 
...
Hence, the changes in birth spacing may be much larger in India than what we have
observed in other places as they developed.

Understanding how birth spacing changes is important for three reasons.

First, tempo effects, arising from changes in birth spacing, biases the total fertility 
rate (TFR), in the sense that the TFR becomes a more biased measure of cohort fertility
\citep{Bongaarts1999,Ni-Bhrolchain2011}.
Hence, it is possible that fertility is, in fact, substantially higher than what
is generally accepted based on the TFR.
...
Instead, longer birth intervals in the absence of sons, which previously would be 
taken as an indicator of lower son preference, may now instead arise because couples 
with a strong son preference use sex selection.

Here, I examine how birth spacing in India has changed over time and across 
groups with the introduction of sex selection.
I apply an empirical method that directly incorporates the effects of 
